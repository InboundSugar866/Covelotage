      ...
      <div >
        <div className='backgroundImage' style={{backgroundImage: `url(${backgroundImage})`}}>
          <div className="container">
            ...
            <div className='intro'>
              <h1 className='h1'>Covelotage</h1>
              <h2 className='h2'>Votre Communaute Cycliste</h2>
            ...
            <h2 className='h2'>Mentions legales</h2>
            <div className='mentions'>
              <h3 className='h3'>Directeur de publication</h3>
              <text className='text'>Denis HEFTRE - Président <br/>
                    Association PDIE Technopôle Nancy Brabois<br/>
                    chez ADH - 5 rue de l’aviation - 54600 VILLERS-LES-NANCY
              </text>

              <h3 className='h3'>Conception et animation du site</h3>
              <text className='text'>ENSEM Conseil - 2 avenue de la forêt de Haye 54500 VANDOEUVRE-LES-NANCY<br/>
                    <br/>
                    Hébergement - XXXX
              </text>

              <h3 className='h3'>Conditions generales d'utilisation du site et des services proposes</h3>
              <text className='text'>L’utilisation du site www.covelotage.fr implique l’acceptation pleine et entière des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site www.covelotage.fr sont donc invités à les consulter de manière régulière.<br/>
                <br/>
              ...
              <h3 className='h3'>Gestion des donnees personnelles</h3>
              <text className='text'>En France, les données personnelles sont notamment protégées par la loi n° 78/87 du 6 janvier 1978, la loi n° 2004/801 du 6 août 2004, l’article L. 226-13 du Code pénal, la Directive Européenne du 24 octobre 1995 et le règlement n° 2016/679 dit, Règlement sur la Protection des Données (RGPD), de l’Union Européenne.<br/>
                <br/>
